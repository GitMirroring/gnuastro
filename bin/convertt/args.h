...
struct argp_option program_options[] =
  {
    ...
    {
      "cmapblankcolor",
      UI_KEY_CMAPBLANKCOLOR,
      "STR",
      0,
      "Blank color name in color maps.",
      GAL_OPTIONS_GROUP_OUTPUT,
      &p->cmapblankcolor,
      GAL_TYPE_STRING,
      GAL_OPTIONS_RANGE_ANY,
    ...
    },
    {
      ...
      0,
      0,
      "Color map to include in PGFPlots (in LaTeX).",
      GAL_OPTIONS_GROUP_OUTPUT,
      &p->cmappgfplots,
      GAL_OPTIONS_NO_ARG_TYPE,
      GAL_OPTIONS_RANGE_0_OR_1,
    ...
    },
    {
      ...
      0,
      0,
      "Force --fluxmin, even when smaller than min.",
      UI_GROUP_FLUX,
      &p->forcemin,
      GAL_OPTIONS_NO_ARG_TYPE,
      GAL_OPTIONS_RANGE_0_OR_1,
    ...
    },
    {
      ...
      0,
      0,
      "Force --fluxmax, even when larger than max.",
      UI_GROUP_FLUX,
      &p->forcemax,
      GAL_OPTIONS_NO_ARG_TYPE,
      GAL_OPTIONS_RANGE_0_OR_1,
